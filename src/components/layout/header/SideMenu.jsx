...
const SideMenu = () => {
  ...
  return (
    <aside className={`fixed top-4/6 md:top-1/2 ${ showSideMenu ? "max-md:-left-1" : "max-md:-left-19" } md:-left-1.5 -translate-y-1/2 rounded-e-2xl p-2 flex flex-col dark:bg-gray-900 transition-all duration-100 ease-linear`}>
