...
const SideMenu = () => {
  ...
  return (
    <aside className={`fixed top-1/2 ${ showSideMenu ? "max-md:left-0" : "max-md:-left-19" } md:left-0 -translate-y-1/2 rounded-e-2xl p-2 lg:p-2 flex flex-col dark:bg-gray-900 transition-all duration-100 ease-linear`}>
