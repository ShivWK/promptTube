    ...
    return (
        <div className="mt-2 flex gap-2 md:gap-3 p-1 my-2.5 w-full">
            ...
            <div onClick={() => setShowCompleteComment(true)} className={`flex flex-col gap-1`}>
                ...
                <p ref={commentPara} className={`text-sm leading-4.5 w-full truncate whitespace-normal ${showMore ? "max-h-auto" : "max-h-9"} `} dangerouslySetInnerHTML={{ __html: data.textDisplay }}></p>
